...
public class VideoPlayer extends SimpleApplication {
	...
	private static final Format			TEXTURE_FORMAT	= Format.RGBA8;
	...
	public static void main(String[] args) {
		...
		new VideoPlayer(args[0], vlcArgs).start();

	}

	public VideoPlayer(String args, String[] vlcArgs) {
...
//		videoImage.setData(tmp);
	...
	private final class MyBufferFormatCallbackAdapter implements BufferFormatCallback {
		...
		public BufferFormat getBufferFormat(int sourceWidth, int sourceHeight) {
			return new BufferFormat(VIDEO_FORMAT, sourceWidth, sourceHeight, new int[]{sourceWidth*4}, new int[]{sourceHeight});
		}
