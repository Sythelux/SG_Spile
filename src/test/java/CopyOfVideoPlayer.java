 ...
 */
public class CopyOfVideoPlayer extends SimpleApplication implements RenderCallback {
	 ...
	 */
	private static final String			MRL				= "/home/sythelux/Videos/[TnF]D.Gray-man_048_SD[D92BA7CE].mp4";
	...
	public static void main(String[] args) {
		...
		CopyOfVideoPlayer app = new CopyOfVideoPlayer();
		app.start();
	}
	...
	public void display(DirectMediaPlayer mediaPlayer, Memory[] nativeBuffers, BufferFormat bufferFormat) {
		// videoImage.setData(mediaPlayer.getByteBuffer(0, WIDTH * HEIGHT *
		// DEPTH));
